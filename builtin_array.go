...
func createArrayProtoTemplate() *objectTemplate {
	...
	t.putStr("indexOf", func(r *Runtime) Value {
		value, _ := r.Intrinsic(IntrinsicArrayIndexOf)
		return valueProp(value, true, false, true)
	})
	t.putStr("join", func(r *Runtime) Value {
		value, _ := r.Intrinsic(IntrinsicArrayJoin)
		return valueProp(value, true, false, true)
	})
	...
	t.putStr("slice", func(r *Runtime) Value {
		value, _ := r.Intrinsic(IntrinsicArraySlice)
		return valueProp(value, true, false, true)
	})
	...
	t.putStr("splice", func(r *Runtime) Value {
		value, _ := r.Intrinsic(IntrinsicArraySplice)
		return valueProp(value, true, false, true)
	})
